...
public final class QuestionBankContent {
    ...
    private static final List<SeedQuestion> HINDI_NATIVE_NURSERY = List.of(
            ...
            mcq("‘गाय’ हमें क्या देती है?", "दूध", "अंडा", "पानी", "रोटी"),
            mcq("सूरज कब निकलता है?", "सुबह", "रात को", "सोते समय", "आधी रात को"),
            mcq("‘क’ से शुरू होने वाला शब्द कौन-सा है?", "कबूतर", "मोर", "तोता", "मछली"),
            mcq("‘गेंद’ कैसी दिखती है?", "गोल", "चौकोर", "लंबी", "तिकोनी"),
            tf("‘अ’ हिंदी का एक अक्षर है।", true),
            tf("मछली पेड़ पर रहती है।", false)
    );
    ...
    private static final List<SeedQuestion> HINDI_NATIVE_LKG = List.of(
            ...
            mcq("‘ख’ से शुरू होने वाला शब्द कौन-सा है?", "खरगोश", "कबूतर", "गाय", "मोर"),
            mcq("‘ग’ से शुरू होने वाला शब्द कौन-सा है?", "गमला", "कमल", "मटका", "थाली"),
            mcq("‘अ’, ‘आ’, ‘इ’ क्या कहलाते हैं?", "स्वर", "व्यंजन", "शब्द", "वाक्य"),
            mcq("‘म’ से शुरू होने वाला जानवर कौन-सा है?", "मोर", "कुत्ता", "बिल्ली", "घोड़ा"),
    ...
    private static final List<SeedQuestion> HINDI_NATIVE_SRKG = List.of(
            ...
            mcq("‘अब’ में कितने अक्षर हैं?", "दो", "एक", "तीन", "चार"),
            mcq("‘घर’ में पहला अक्षर कौन-सा है?", "घ", "र", "ग", "ख"),
            mcq("‘आ’ की मात्रा वाला शब्द कौन-सा है?", "आम", "इमली", "उल्लू", "एकतारा"),
            mcq("‘मामा’ में कौन-सी मात्रा है?", "आ की", "इ की", "उ की", "ए की"),
    ...
    /** Class 1: varnmala order, matras (इ, ई, उ), simple word sense — Devanagari. */
    private static final List<SeedQuestion> HINDI_NATIVE_C1 = List.of(
            mcq("हिंदी वर्णमाला में ‘ग’ के बाद क्या आता है?", "घ", "ख", "ङ", "च"),
            mcq("‘किताब’ में ‘ि’ की मात्रा किस अक्षर पर है?", "क", "त", "ब", "भ"),
            mcq("‘मिला’ में कौन-सी मात्रा है?", "आ की", "इ की", "ई की", "उ की"),
            mcq("‘ई’ की मात्रा वाला शब्द कौन-सा है?", "सीता", "कलम", "घर", "नल"),
            mcq("‘उ’ की मात्रा वाला शब्द कौन-सा है?", "गुड़िया", "मेला", "तारा", "केला"),
            mcq("‘चम्मच’ किस अक्षर से शुरू होता है?", "च", "छ", "ज", "ट"),
            mcq("‘त’ के बाद क्या आता है?", "थ", "द", "न", "प"),
    ...
    /** Class 2: sangya/sarvnam intro, simple vilom, matra in words — Devanagari. */
    private static final List<SeedQuestion> HINDI_NATIVE_C2 = List.of(
            ...
            mcq("‘लड़का खेलता है’ — इसमें संज्ञा क्या है?", "लड़का", "खेलता", "है", "ता"),
            mcq("‘राम’ के बदले कौन-सा सर्वनाम आएगा?", "वह", "मैं", "तुम", "हम"),
    ...
    /** Class 3: visheshan/kriya, paryayvachi, Hindi ginti — Devanagari. */
    private static final List<SeedQuestion> HINDI_NATIVE_C3 = List.of(
            mcq("‘सीता गाना गाती है’ — इसमें क्रिया क्या है?", "गाती है", "सीता", "गाना", "है"),
            mcq("‘लाल फूल’ में विशेषण क्या है?", "लाल", "फूल", "लाल फूल", "में"),
            mcq("‘मीठा आम’ में ‘मीठा’ क्या है?", "विशेषण", "संज्ञा", "सर्वनाम", "क्रिया"),
            mcq("‘आकाश’ का पर्यायवाची क्या है?", "गगन", "धरती", "पानी", "आग"),
            mcq("‘आँख’ का पर्यायवाची क्या है?", "नेत्र", "नाक", "कान", "मुँह"),
            mcq("‘सुबह’ का विलोम क्या है?", "शाम", "दोपहर", "रात", "सवेरा"),
            mcq("‘जीत’ का विलोम क्या है?", "हार", "खेल", "दौड़", "मैच"),
    ...
    /** Class 4: vilom/paryayvachi harder, simple muhavare, sangya bhed — Devanagari. */
    private static final List<SeedQuestion> HINDI_NATIVE_C4 = List.of(
            mcq("‘स्वतंत्र’ का विलोम क्या है?", "परतंत्र", "आज़ाद", "मुक्त", "स्वदेशी"),
            mcq("‘अंधकार’ का पर्यायवाची क्या है?", "अँधेरा", "उजाला", "सवेरा", "शाम"),
            mcq("‘कमल’ का पर्यायवाची क्या है?", "पंकज", "गुलाब", "गेंदा", "चमेली"),
            mcq("‘आँखों का तारा’ का अर्थ क्या है?", "बहुत प्यारा", "बहुत दूर", "बहुत चमकीला", "बहुत छोटा"),
            mcq("‘नौ दो ग्यारह होना’ का अर्थ क्या है?", "भाग जाना", "खुश होना", "लड़ना", "सो जाना"),
            mcq("‘मोहन’, ‘दिल्ली’, ‘गंगा’ कैसी संज्ञा हैं?", "व्यक्तिवाचक", "जातिवाचक", "भाववाचक", "सर्वनाम"),
            mcq("‘लड़का’, ‘शहर’, ‘नदी’ कैसी संज्ञा हैं?", "जातिवाचक", "व्यक्तिवाचक", "भाववाचक", "विशेषण"),
    ...
    private static List<SeedQuestion> hindiNativeFor(String band) {
        ...
        int n = classNumber(t);
        return switch (n) {
            case 1 -> HINDI_NATIVE_C1;
            case 2 -> HINDI_NATIVE_C2;
            case 3 -> HINDI_NATIVE_C3;
            case 4 -> HINDI_NATIVE_C4;
            default -> n >= 6 ? HINDI_NATIVE_UPPER : HINDI_NATIVE_C4;
        };
    }
