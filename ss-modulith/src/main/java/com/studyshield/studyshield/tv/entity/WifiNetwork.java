...
public class WifiNetwork {
    ...
    private com.studyshield.studyshield.tv.entity.TvUser user;
    ...
    public TvUser getUser() { return user; }
    public void setUser(com.studyshield.studyshield.tv.entity.TvUser user) { this.user = user; }
    ...
    public static class Builder {
        ...
        public Builder user(com.studyshield.studyshield.tv.entity.TvUser user) { this.user = user; return this; }
